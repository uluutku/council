...
Create the Council repository foundation without implementing product features.
...
Council is a private web messenger for human direct messaging and clearly labeled AI contacts.
The locked product and engineering decisions are recorded in `docs/`.
...
from frontend source. The repository documents encrypted transport, protected storage,
RLS-first authorization, restricted logging, and the external AI provider boundary.
